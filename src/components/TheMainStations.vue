...
const createBubbleGraph = async () => {
  ...
  const legendGroup = svg
    ...
    .attr(
      'transform',
      `translate(${width - maxRadiusReal * 2 - legendPadding}, ${
        height - maxRadiusReal * 2 - legendPadding
      })`
    )
  ...
  legendGroup
    ...
    .text(
      `Min : ${formatBigNumber(minPassengers)} / Max : ${formatBigNumber(
        maxPassengers
      )}`
    )
}
